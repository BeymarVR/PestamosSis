...
class PagoController extends Controller
{
    ...
    public function store(Request $request)    {
        ...
        try {
            ...
            \App\Services\ActivityLogger::log('creacion', "Registro de pago de Bs {$request->monto} para préstamo {$planPago->prestamo->codigo} (Cuota #{$planPago->numero_cuota})", $pago, null, $pago->toArray());
